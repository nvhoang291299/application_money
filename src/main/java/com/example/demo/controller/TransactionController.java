...
public class TransactionController {
    ...
    public ResponseEntity<String> displayBalance(@PathVariable("username") String username) {
    ...
    public ResponseEntity<String> saveMoney(@Valid @RequestBody TransactionRequest request,
